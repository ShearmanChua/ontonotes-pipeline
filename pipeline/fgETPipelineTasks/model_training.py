...
def model_training():
    ...
    arg_parser.add_argument('--fgETdata_dataset_name', type=str, default='fgET HAnDS data')
    arg_parser.add_argument('--train_file_name', type=str, default='train_0.parquet')
    arg_parser.add_argument('--val_file_name', type=str, default='validation_0.parquet')
    arg_parser.add_argument('--test_file_name', type=str, default='test_0.parquet')
