...
def model_training():
    ...
    arg_parser.add_argument('--results_dataset_name', type=str, default='fgET results fine-tuning on FIGER test')
    ...
    arg_parser.add_argument('--model_checkpoint_dataset_name', type=str, default='fgET results fine-tuning on FIGER')
