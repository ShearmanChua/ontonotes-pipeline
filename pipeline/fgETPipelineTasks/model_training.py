...
def model_training():
    ...
    PROJECT_NAME = "fgET"
    TASK_NAME = "model fine tuning on HAnDS"
    ...
    arg_parser.add_argument('--fgETdata_dataset_name', type=str, default='fgET HAnDS next 100k')
    ...
    arg_parser.add_argument('--results_dataset_name', type=str, default='fgET results fine-tuning on HAnDS')
